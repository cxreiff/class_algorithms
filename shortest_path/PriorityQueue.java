 ...
 *
 * K : the types of the keys in this priority queue
 * V : the types of the values in this priority queue
 *
 * @author Jim Glenn
...
public class PriorityQueue<K, V extends Comparable<? super V>>
{
    /**
